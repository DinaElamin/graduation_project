...
class SemesterTwoWidget extends StatefulWidget {
  ...
  @override
  State<SemesterTwoWidget> createState() => _SemesterOneDropDownState();
}

class _SemesterOneDropDownState extends State<SemesterTwoWidget> {
          ...
          GestureDetector(
            ...
            child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      S.of(context).semester_two_subject,
